...
ALPACA_API_KEY = constants.ALPACA_API_KEY2
ALPACA_SECRET_KEY = constants.ALPACA_SECRET_KEY2
...
class ScalpAlgo:
    def __init__(self, api, symbol, lot):
        ...
        while 1:
            ...
            try:
                print('before get_bars', today, tomorrow)
                data = api.get_bars(symbol, TimeFrame.Minute, start=today,
                                    adjustment='raw').df
                #print('after get_bars', data)
                break
